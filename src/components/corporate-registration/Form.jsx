    ...
    <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <Grid item md={6}>
              <Stack>
                ...
                >
                  {item}{" "}
                  {index === 0 ? (
                    <BsAsterisk color="red" fontSize="10px" />
                  ) : null}
                </InputLabel>
                <TextField
                  size="small"
          ...
          return (
            <Grid item md={4}>
              <Stack>
                ...
                >
                  {item.label}{" "}
                  {item.validation.required.value ? (
                    <BsAsterisk color="red" fontSize="10px" />
                  ) : null}
                </InputLabel>
                <TextField
                  type={item.type}
                  size="small"
                  {...register(item.label, item.validation)}
      ...
      <FormControl>
        <FormLabel
          ...
          sx={{ fontWeight: "500", fontSize: "13px", marginBottom: "3px" }}
        >
          Foreign Owned
        </FormLabel>
        <RadioGroup
      ...
      <Stack sx={{ display: "flex", alignItems: "center" }}>
        <Button
          sx={{ padding: "10px 80px", backgroundColor: "hsl(249deg 68% 29%)" }}
          type="submit"
          variant="contained"
        >
          Save
